...
#'
#' @usage intensity(x, date1="1950-05-01", date2="1950-07-15", date3="1950-07-16", date4="1950-09-30")
#'
...
#' r<-intensity(x)
#' @export
intensity<-function(x, date1="1950-05-01", date2="1950-07-15", date3="1950-07-16", date4="1950-09-30"){
